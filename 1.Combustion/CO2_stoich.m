function [X_CO2]=CO2_stoich(gastype,w_d)
%Function that estimates the stoichiometric CO2 molar fraction using a simplified single-order combustion model

%Inputs: Gas Type [-], 'wet' or 'dry' fraction?  [-]
%Outputs: X_CO2 - [%]
