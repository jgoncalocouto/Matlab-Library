function [N_CO2,N_H2O,N_N2,N_O2]=exgases_moles(lambda,gastype,w_d)
%Function that estimates the exhaust gases' molar quantities for 1 mole of combustible using a simplified single-order combustion model
...
if strcmp(w_d,'wet')==1
    N_CO2=fraction_ch*x;
    N_O2=(2*R4-2*P1-P2)/2;
    N_N2=R4*3.76+fraction_n2;
    N_H2O=(fraction_ch*y+2*fraction_h2)/2;
