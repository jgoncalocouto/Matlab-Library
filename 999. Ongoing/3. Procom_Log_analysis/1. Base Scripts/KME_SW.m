...
if strcmp(capacity,'11')==1
    SW_FlowrateLimitLow.NG=-0.2;
    SW_FlowrateLimitLow.LPG=-0.2;
    
    SW_FlowrateLimitUp.NG=0.05;
    SW_FlowrateLimitUp.LPG=0.05;
...
if strcmp(capacity,'11')==1
    SW_I_Flowrate.NG=600;
    SW_I_Flowrate.LPG=600;
elseif strcmp(capacity,'14')==1
    SW_I_Flowrate.NG=500;
    SW_I_Flowrate.LPG=500;
end
...
if strcmp(capacity,'11')==1
    ...
    SW_I_FlowrateLimitLow.NG=-0.15;
    SW_I_FlowrateLimitLow.LPG=-0.15;
    
    SW_I_FlowrateLimitUp.NG=0.3;
    SW_I_FlowrateLimitUp.LPG=0.3;
...
if strcmp(capacity,'11')==1
    ...
    SW_I_ValveCurrentRamp.NG=[
        0 90
        5 115
        ];
    
    SW_I_ValveCurrentRamp.LPG=[
        0 125
        5 145
        ];
elseif strcmp(capacity,'14')==1
