...
sensor_database={
    ...
    'Voltage_direct',{'Voltage','[V]','[V]',1,0,1,0}
    'Current_direct',{'Current','[A]','[mA]',1000,0,1,0}
    'FAFE_Pbox',{'Relative Pressure','[mA]','[mbar]',625,-2.5,1,0}
    'Micromanometer_dpm',{'Relative Pressure','[V]','[mbar]',20,0,1,0}
    ...
    'Ultramat23_CO2_MR2',{'CO2','[mA]','[%]',1562.5,-6.25,1,0}
    ...
    'Digital_signal',{'Logical','[V]','[-]',0.1,0,1,0}
    ...
    'Huba_control_50mbar',{'Relative Pressure','[mA]','[mbar]',12.5,-6.25,1,0}
    };
